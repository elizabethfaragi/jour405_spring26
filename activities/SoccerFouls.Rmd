...
The correlation coefficient is very low (about 0.01), meaning that there is pretty much no correlation between fouls and goal differential The scatterplot shows a straight line, meaning that there is no correlation between the two. 


## Task 7: Choose another variable and repeat the steps in Task 4-5, then describe the results. 
```{r}
...
Corners and goal differentials have a correlation coefficient of 0.379. This means that corner kicks do affect goal differentials, but not a huge amount. You want corner kicks, but you can win without them. 

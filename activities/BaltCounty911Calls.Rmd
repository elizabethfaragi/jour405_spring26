...
I'm really drawn to the really tall line in Oct 2022. I'm curious as to why 911 calls were so frequent that day, given that most days are average and between 5-15 calls. Similarly, the line near Jul 2022 because there was like one or two calls that day, which seems interesting. The pattern looks pretty standard, but there's a drop at Jan 2023, which isn't present in Jan 2022, so wondering why it was so much lower the same time a year later. 
...
They don't differ a lot, but I am noticing that I missed most of the unusually high ones, probably because I was distracted by the random data point near Oct 2022 that is really unusually high. I also didn't notice much of the unusually low ones, probably because I was also distracted by the Oct 2022 high point.  
...
On Tuesday, Oct 4th, the number of overdose calls was above the 95th percentile, with 23 calls in that day.
...
I would report on the unusally high days that are close to each other. Some of the two highest ones are within a week of each other, which makes me wonder whether or not there was a bad batch of drugs or if there was a festival or concert in the area. It would be important for people to know that there is an issue with the drugs being sold in the area, so I'd look into that. 

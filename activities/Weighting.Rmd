...
The range of weights falls between around 0.25 and around 2.65. 

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

That response counts as less than one person when their weight is 0.23, meaning that response is overrepresented in this sample. A weight of 3.04 counts as more than one person, meaning that response is underrepresented in this sample. 

3. Why might some respondents be weighted more heavily than others?

If there are less responses or if that population is more targeted/more populous in a population, they may be weighted more heavily
...
Rarely/never because these follks are super hard to reach. If they're unlikely to vote, they're unlikely to respond to surveys. 

2. How might these differences affect reporting on likely voter turnout?

We're going to misrepresent what voter turnout will be because we're missing this huge chunk of people who don't vote because we can't poll them and can't reach them in survey data. 
...
We can see that people who are overly involved in voting and public service and such may be overrepresented because they like to contribute to community and they are heavily involved in voting. We're likely going to underrepresent those who do not vote and do not participate in community engagement because we can't reach those people through polls and surveys. 

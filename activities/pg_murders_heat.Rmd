...
Murders and temperature have a correlation of almost 0.6. This means that the two are correlated. Based on the scatterplot, I'm seeing that warmer months have a higher rate of murders. So, based on the plot and the correlation coefficient, warmer temperatures mean more murders. 

...
What I'm noticing is the rate of property crimes is much higher than the rate of violent crimes for almost all cities, which is good. The city with the highest violent crime rate in 2019 is Baltimore City, with 18 per 1000 people. Ocean City has the highest property crime rate for 2019, with about 103 crimes per 1000 people. What I've noticed is the cities with higher crime rates on both levels have a higher population that areas with lower crime rates. I'm not sure if there is necessarily a story, more so just more people so more crime. 
...
```{r}
md_cities_change <- md_cities_rates |> mutate (pct_change_violent = ((violent2020-violent2019)/violent2019)*100, pct_change_property=((property2020-property2019)/property2019)*100)
```
...
What's interesting to me is that I'm seeing a lot of 100 percent increases, meaning that these values are doubling. I will say, a lot of the numbers are small, so if violent crime in Annapolis is increasing from 3 to 6 it's really not that deep. However, crime in Baltimore is decreasing. As well, violent crime in Edmonston went up by 900%, which is concerning. However, it went from 0.6 to 6, which makes me wonder how you can have 0.6 violent crimes?  
...
Violent and property crime rates in Baltimore have decreased by 15% and 27% respectfully from 2019 to 2020, data shows. 

Violent crime in Baltimore decreased by about 15%, from 11101 to 9402. Property crime has also decreased, by about 27%, from 25748 to 18540. This means that new policies by Governor Wes Moore are successfully combatting crime.  
...
There are 11 cities in the 90th percentile.
...
I don't think the results change my story. My story is more based on the changes that areas saw, not necessarily where areas ranked in terms of percentile.
